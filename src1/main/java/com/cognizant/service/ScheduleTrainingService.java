...
public class ScheduleTrainingService {
	...
	@Transactional
	public void insertScheduleTraining(ScheduleTraining sTraining, TrainerInfo inputtrainerInfo) throws ScheduleTrainingException {
		...
		if(trainerInfo!=null){
			...
			trainerInfo.setScheduleTraining(sTrainingList);
				...
				throw new ScheduleTrainingException("scheduleTraining.startDate:Invalid Date");
