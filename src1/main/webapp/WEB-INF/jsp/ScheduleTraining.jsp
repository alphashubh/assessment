...
<table>
  ...
  <tr>
    ...
    <tr>
        ...
        required="true" /></td>
        <td><form:errors path="scheduleTraining.startDate" cssClass="error" /></td>
     
    </tr>
    <tr>
    	
        <td >Duration:</td>
        <td><form:select path="scheduleTraining.duration"  placeholder="duration" 
        required="true" id="duration"  ng-model="duration">
